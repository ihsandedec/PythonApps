# 1- Girilen bir sayının 50-100 arasında olup olmadığını kontrol edeceğim
...
# 3- Username ve parola bilgileri ile giriş kontrolü yapacağım. 
# _username = "ihsandedec"
# _password = "123456"
...
# 4- Girilen 3 sayıyı büyüklük olarak karşılaştırdım.
...
# 5- Kullanıcıdan 2 vize (%60) ve final (%40) notunu alıp ortalama hesaplıcam.
...
# 6- Kişinin ad, kilo ve boy bilgilerini alıp kilo indekslerini hesapl.
